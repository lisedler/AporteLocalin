...
<!-- mi header -->
    ...
    <!-- Custom CSS -->
    <link href="<?php echo get_template_directory_uri().'/css/stylish-portfolio.css' ?>" rel="stylesheet">
...
/*
	...
	*/
	...
	if ( is_user_logged_in() ) {
		...
		$rt_out .= "<li id='epi-home'><a href='" .WHATIF_BLOGURL. "'>" . __('Home page','whatif') . "</a></li>";
